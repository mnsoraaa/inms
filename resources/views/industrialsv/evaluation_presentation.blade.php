  ...
  @section('content')
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="panel panel-present" style="margin-bottom: 5%;">
          <div class="panel-heading">
            Presentation
            <div class="pull-right">
              Current percentage: @if(!empty($evaluation)){{ $evaluation->markPresent }}@else{{ '0' }}@endif %
            </div>
          </div>
          <div class="panel-body">
            ...
            <div class="form-group">
              <table cellspacing="0" class="table table-bordered table-responsive" width="100%">
                <tbody>
                  ...
                  <tr>
                    <td>Able to present without reading the slide.</td>
                  ...
                  <tr>
                    <td>Able to shared the experience confidently.</td>
                  ...
                  <tr>
                    <td>Have good communication between student and audience.</td>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <div class="input textarea required">
                  <form action="{{ url('/evaluation/add/presentation') }}" method="POST" id="evaluationPresentation">
                    {{ csrf_field() }}
                    <textarea class="form-control" id="remarksPresent" name="remarksPresent" required="required" rows="5">@if(!empty($evaluation)){{ $evaluation->remarksPresent }}@endif</textarea>
                    <input type="hidden" name="markPresent" id="markPresent" value="">
            ...
            <div class="form-group" style="margin-top: 80px;">
              <div class="col-sm-offset-2 col-sm-10">
                <div class="action-fixed-bottom animated bounceInUp">
                  <button form="evaluationPresentation" class="btn btn-success" name="save" type="submit" value="save"><i class="fa fa-save"></i> Save</button>
