  ...
  @section('content')
    ...
    <div class="row">
      <div class="col-sm-12">
        ...
        <div class="panel panel-logbook" style="margin-bottom: 5%;">
          <div class="panel-heading">
            Logbook
            <div class="pull-right">
              Current percentage: @if(!empty($evaluation)){{ $evaluation->markLogbook }}@else{{ '0' }}@endif %
            </div>
          </div>
          <div class="panel-body">
            ...
            <div class="form-group">
              <table cellspacing="0" class="table table-bordered table-responsive" width="100%">
                <tbody>
                  ...
                  <tr>
                    <td>Able to plan activities tasks sufficiently during training.</td>
                  ...
                  <tr>
                    <td>Able to write weekly summary of activities.</td>
                  ...
                  <tr>
                    <td>The summary of the tasks is details and suitable for the course.</td>
            ...
            <div class="form-group">
              ...
              <div class="col-sm-12">
                <div class="input textarea required">
                  <form action="{{ url('/evaluation/add/logbook') }}" method="POST" id="evaluationLogbook">
                    {{ csrf_field() }}
                    <textarea class="form-control" id="remarksLogbook" name="remarksLogbook" required="required" rows="5">@if(!empty($evaluation)){{ $evaluation->remarksLogbook }}@endif</textarea>
                    <input type="hidden" name="markLogbook" id="markLogbook" value="">
            ...
            <div class="form-group" style="margin-top: 80px;">
              <div class="col-sm-offset-2 col-sm-10">
                <div class="action-fixed-bottom animated bounceInUp">
                  <button form="evaluationLogbook" class="btn btn-success" name="save" type="submit" value="save"><i class="fa fa-save"></i> Save</button>
